...
/*   Updated: 2023/07/10 06:28:21 by nbled            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	data_init(t_data *data)
{
	...
	data->north_texture->texture = mlx_xpm_file_to_image(data->mlx, "textures/cobblestone.xpm", &data->north_texture->x, &data->north_texture->y);
	data->south_texture = malloc(sizeof(t_texture));
	data->south_texture->texture = mlx_xpm_file_to_image(data->mlx, "textures/grass.xpm", &data->south_texture->x, &data->south_texture->y);
	data->est_texture = malloc(sizeof(t_texture));
	data->est_texture->texture = mlx_xpm_file_to_image(data->mlx, "textures/three.xpm", &data->est_texture->x, &data->est_texture->y);
